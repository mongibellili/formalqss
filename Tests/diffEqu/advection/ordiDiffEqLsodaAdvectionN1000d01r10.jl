...
function odeDiffEquPackage()
   ...
   #=  solFeagin14 = solve(prob,Feagin14(),saveat=0.01,abstol = 1e-12, reltol = 1e-8)
     ...
     BSON.@save "formalqss/ref_bson/solVectAdvection_N1000d01_Feagin14e-12.bson" solFeagin14VectorN1000d01r10 =#
...
println("breakpt1")
  ...
  println("breakpt4") 
  err2=getAverageErrorByRefs(sollsoda.u,solFeagin14VectorN1000d01r10,1000,1000)
  @show  err2
 ...
 XLSX.openxlsx("ADR_diffEq_lsoda_N1000d01r10_.xlsx", mode="w") do xf
  sheet = xf[1]
  sheet["A1"] = "ADR_diffEq_implicit_N1000d01r10 lsoda__"
  sheet["A2"] = "__e-2_e-5)"
