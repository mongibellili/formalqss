...
function odeDiffEquPackage()
  ...
  #=  solFeagin14 = solve(prob,Feagin14(),saveat=0.01,abstol = 1e-12, reltol = 1e-8)
     solFeagin14VectorN1000d01r10=solFeagin14.u
     BSON.@save "formalqss/ref_bson/solVectAdvection_N1000d01r10_Feagin14e-12.bson" solFeagin14VectorN1000d01r10 =#
     
  BSON.@load "formalqss/ref_bson/solVectAdvection_N1000d01r10_Feagin14e-12.bson" solFeagin14VectorN1000d01r10   

  absTol=1e-5
    relTol=1e-2
solBS3 = solve(prob,BS3(),saveat=0.01,abstol = absTol, reltol = relTol) #1.235 ms (1598 allocations: 235.42 KiB)
println("breakpt3") 
err1=getAverageErrorByRefs(solBS3.u,solFeagin14VectorN1000d01r10,1000,1000)
@show  err1
 ...
 println("breakpt4") 
 err2=getAverageErrorByRefs(solRalston.u,solFeagin14VectorN1000d01r10,1000,1000)
 @show  err2
...
@show resRalston_3
 ...
 XLSX.openxlsx("ADR_diffEq_explicit_N1000d01r10_.xlsx", mode="w") do xf
  sheet = xf[1]
  sheet["A1"] = "ADR_diffEq_implicit_N1000d01r10 2 solvers__"
  sheet["A2"] = "__e-2_e-5)"
