...
function cubic5(a::Float64, b::Float64, c::Float64, d::Float64) #where F <: AbstractFloat
  _a = 1.0 / a
...
function cubic6(coeffs::NTuple{4,Float64})#where F <: AbstractFloat
  _a = 1.0 / coeffs[4]
...
function cubic7(coeffs::SVector{4,Float64})#where F <: AbstractFloat
  _a = 1.0 / coeffs[4]
  b, c, d = coeffs[3] * _a, coeffs[2] * _a, coeffs[1] * _a
  m = b < c ? b : c
  m = d < m ? d : m
...
#coeffs=NTuple{4,Float64}((-6.0,1.0,12.65,1.33))
...
@show cubic6(coeffs2)
 =#
#= @show cubic4(0.0,-2.0,1.0,6.0)
@show cubic5(0.0,-2.0,1.0,6.0) =#