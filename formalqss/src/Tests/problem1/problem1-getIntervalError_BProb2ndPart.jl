...
function test11()
   ...
   # save_Sol(solmliqss1)
    ...
    er1=getIntervalError(solmliqss1,1,x1,0.0,20.0)  
    er2=getIntervalError(solmliqss1,2,x2,0.0,20.0)  
    er1b=getIntervalError(solmliqss1,1,x1,20.0,1000.0)  
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  

     ("B11","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test12()
   ...
   # save_prob_to_model(odeprob,"D://QS_Solver//qss//src//models//InvestigateBProblem.jl","B12") #any location you want
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B12","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test13()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B13","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test14()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B14","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test15()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B15","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test21()
    ...
    er1=getIntervalError(solmliqss1,1,x1,0.0,60.0)  
    er2=getIntervalError(solmliqss1,2,x2,0.0,60.0)  
    er1b=getIntervalError(solmliqss1,1,x1,60.0,1000.0)  
    er2b=getIntervalError(solmliqss1,2,x2,60.0,1000.0)  

     ("B21","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test22()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,60.0,1000.0)  
     ...
     ("B22","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test23()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,60.0,1000.0)  
     ...
     ("B23","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test24()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,60.0,1000.0)  
     ...
     ("B24","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test25()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,60.0,1000.0)  
     ...
     ("B25","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test31()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B31","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test32()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B32","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test33()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B33","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test34()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B34","1stPart",er1,er2,"2ndPart",er1b,er2b)
...
function test35()
    ...
    er2b=getIntervalError(solmliqss1,2,x2,20.0,1000.0)  
     ...
     ("B35","1stPart",er1,er2,"2ndPart",er1b,er2b)
   
end
err35=test35()


open("qssv012ndpart.txt","a") do io
    println(io,"qssv01_2ndPart")
    println(io,err11)
    println(io,err12)
    println(io,err13)
    println(io,err14)
